        ...
        <div className="card p-8">
          ...
          <div className="relative my-5">
            <div className="absolute inset-0 flex items-center">
              <div className="w-full border-t border-beige-200 dark:border-brown-300" />
            </div>
            <div className="relative flex justify-center">
              <span className="px-3 bg-white dark:bg-brown-400 text-xs text-brown-200 dark:text-beige-300">
                or
              </span>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-brown-200 hover:text-brown-400"
                >
          ...
          <p className="text-center text-sm text-brown-200 dark:text-beige-300 mt-5">
            No account?{" "}
            <Link href="/signup" className="text-rust hover:underline">
              Create one
            </Link>
          </p>
        </div>
